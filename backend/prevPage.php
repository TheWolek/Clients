                    ...
                    if($result->num_rows > 0) {
                        ...
                        while($row=$result->fetch_assoc()) {
                            ...
                            if ($row['data_wizyty'] < $date) {
                                echo "<td>{$row['data_wizyty']}<span class='badge badge-danger ml-1'>Stary</span></td>";
                            } else if($row['data_wizyty'] == $date) {
                                echo "<td>{$row['data_wizyty']}<span class='badge badge-success ml-1'>Dzisiaj</span></td>";
                            } else {
                        ...
                        echo "</tbody></table>";
                        if($offset == 0) {
                            echo "<form action='nextPage.php' method='post' class='nav-form'><input type='submit' value='Next' class='btn btn-primary'/></form>";
                        } else {
