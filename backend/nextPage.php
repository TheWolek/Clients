                ...
                <?php
                    ...
                    if($result->num_rows > 0) {
                        ...
                        if($curPage == $pageTotal) 
                            echo "<form action='prevPage.php' method='post' class='nav-form'><input type='submit' value='prev' class='form-control'/></form>";
                        else
                            echo "<form action='nextPage.php' method='post' class='nav-form'><input type='submit' value='Next' class='form-control'/></form><form action='prevPage.php' method='post' class='nav-form'><input type='submit' value='prev' class='form-control mt-1'/></form>";
                    } else {
