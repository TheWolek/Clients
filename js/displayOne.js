...
function findOne(id) {
    ...
    $.get(url, function (data) {
        ...
        output += "<span class='client-id' id='client-id'>" + CID + "</span> <span class='client-name' id='client-name" + CID + "'>Imię i Nazwisko: <span class='text-danger'>" + name + "</span></span><button class='btn btn-primary client-proc-add' onclick='addProc(" + CID + ")'>Dodaj</button><div id='client-proc'>Zabiegi:</div></div>"
        area.html(output)
